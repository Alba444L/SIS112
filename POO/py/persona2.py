    ...
    def modificar_carrera(self):
        while True:
            ...
            if nueva_carrera.isalpha():
                ...
                print("Carrera inválida, ingresa solo letras")
        return f'Estoy estudiando {self.carrera}.'
...
persona = Persona('Alba', 19, 'Ingeniería Industrial', 'UCB')
...
while True:
    ...
    if opcion == "1":
        ...
        print("Ya salió del programa")
        break
    else:
        print("Opción inválida, porfavor solo ingrese las opciones dadas")